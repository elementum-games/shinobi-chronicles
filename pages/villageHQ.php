...
function villageHQ() {
	...
	<ul class='submenu'>
		<li style='width:30.5%;'><a href='{$system->router->links['villageHQ']}&view=village_info'>Village Info</a></li>
		<li style='width:23%;'><a href='{$system->router->links['villageHQ']}&view=members'>Members</a></li>
		<li style='width:25.5%;'><a href='{$system->router->links['villageHQ']}&view=clans_teams'>Clans/Teams</a></li>
