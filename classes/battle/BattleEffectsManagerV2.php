...
class BattleEffectsManagerV2 {
    ...
    /**
     * BattleEffectsManagerV2 constructor.
     * @param System $system
    ...
    public function applyPassiveEffect(Fighter $target, BattleEffect $effect): bool {
        ...
        if($effect_amount < $effect->effect_amount * BattleV2::MIN_DEBUFF_RATIO) {
            $effect_amount = $effect->effect_amount * BattleV2::MIN_DEBUFF_RATIO;
        }
