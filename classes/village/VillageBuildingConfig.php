...
class VillageBuildingConfig {
    ...
    const UPGRADE_SET_DESCRIPTIONS = [
        ...
        self::UPGRADE_SET_KEY_POWER_PROJECTION => "Increases stability of controlled regions.",
        ...
        self::UPGRADE_SET_KEY_FORTIFICATIONS => "Increases health of villages and castles.",
