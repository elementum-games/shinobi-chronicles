    ...
    */
    public static array $difficulties = [
        SpecialMission::DIFFICULTY_EASY => [
            ...
            'rep_gain' => Village::Special_Mission_Gains[SpecialMission::DIFFICULTY_EASY],
        ],
        ...
        SpecialMission::DIFFICULTY_NORMAL => [
            ...
            'rep_gain' => Village::Special_Mission_Gains[SpecialMission::DIFFICULTY_NORMAL],
        ],
        SpecialMission::DIFFICULTY_HARD => [
            ...
            'rep_gain' => Village::Special_Mission_Gains[SpecialMission::DIFFICULTY_HARD],
        ],
        SpecialMission::DIFFICULTY_NIGHTMARE => [
            ...
            'rep_gain' => Village::Special_Mission_Gains[SpecialMission::DIFFICULTY_NIGHTMARE],
        ]
    ];
