...
function Topbar({
  ...
  const rightNotificationTypes = ["specialmission", "specialmission_complete", "specialmission_failed", "rank", "system", "warning", "report", "battle", "challenge", "team", "marriage", "student", "inbox"];
