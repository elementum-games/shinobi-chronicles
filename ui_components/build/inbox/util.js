...
export function timeSince(timestamp, format = 'single', ago = false) {
  ...
  let milli = Math.abs(lastTimestamp - currentDate); // years (365 days)

  timeType.year.value = Math.floor(milli / (1000 * 60 * 60 * 24 * 365));
  milli = Math.floor(milli % (1000 * 60 * 60 * 24 * 365)); // months (30 days)

  timeType.month.value = Math.floor(milli / (1000 * 60 * 60 * 24 * 30));
  milli = Math.floor(milli % (1000 * 60 * 60 * 24 * 30)); // weeks (7 days)

  timeType.week.value = Math.floor(milli / (1000 * 60 * 60 * 24 * 7));
  milli = Math.floor(milli % (1000 * 60 * 60 * 24 * 7)); // days (24 hours)

  timeType.day.value = Math.floor(milli / (1000 * 60 * 60 * 24));
  milli = Math.floor(milli % (1000 * 60 * 60 * 24)); // hours (60 minutes)

  timeType.hour.value = Math.floor(milli / (1000 * 60 * 60));
  milli = Math.floor(milli % (1000 * 60 * 60)); // minutes (60 seconds)

  timeType.minute.value = Math.floor(milli / (1000 * 60));
  milli = Math.floor(milli % (1000 * 60)); // seconds (1000 milliseconds)

  timeType.second.value = Math.floor(milli / 1000);
  milli = Math.floor(milli % 1000); // loop through each year, month, etc.
  ...
  for (const timeKey in timeType) {
    ...
    if (timeType[timeKey].value) {
      ...
      string += timeType[timeKey].value + name; // add an s if more than 1
