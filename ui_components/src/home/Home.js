...
function NewsSection({ newsRef, initialNewsPosts, homeLinks, isAdmin, version }) {
        ...
        return (
            <div className="news_item_editor">
                <div className={activePostId == newsItem.post_id ? "news_item_header" : "news_item_header news_item_header_minimized"} onClick={() => setActivePostId(newsItem.post_id)}>
                    ...
                    <div className="news_item_version" ref={versionRef} contentEditable="true" suppressContentEditableWarning={true} style={{ minWidth: "25px"}}>{newsItem.version && newsItem.version.toUpperCase()}</div>
