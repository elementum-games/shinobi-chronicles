...
export function ResourceBar({currentAmount, maxAmount, resourceType}) {
    ...
    return (
        <div className='resourceBarOuter' style={styles.resourceBarOuter}>
            <div style={{
                ...styles.resourceFill,
                ...resourceFillStyle,
                width: `${resource_percent}%`
            }}>&nbsp;</div>
            <div className='text' style={styles.resourceBarOuterText}>{currentAmount.toFixed(2)} / {maxAmount.toFixed(2)}</div>
        </div>
    );
}
