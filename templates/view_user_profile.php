    ...
    <tr>
        ...
        <tr><td style='text-align:center;' colspan='2'>
            ...
            <?php if($player->rank_num > 1): ?>
                &nbsp;&nbsp;|&nbsp;&nbsp;<a href='<?= $system->router->links['send_money'] ?>&recipient=<?= $viewUser->user_name ?>'>Send <?=$player->currency->money->name?></a>
                &nbsp;&nbsp;|&nbsp;&nbsp;<a href='<?= $system->router->links['send_money'] ?>&recipient=<?= $viewUser->user_name ?>'>Send <?=$player->currency->premium_credits->symbol?></a>
            <?php endif; ?>
