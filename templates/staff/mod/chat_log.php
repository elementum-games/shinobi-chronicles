        ...
        <tr>
            <td style="text-align: center;">
                <form action="<?=$self_link?>" method="get">
                    <input type="hidden" name="id" value="<?=System::PAGE_IDS['chat_log']?>" />
...
<table class="table" style="table-layout: auto;">
    <tr><th colspan="3">Chat Log <?=($report ? " - <a href='{$system->links['report']}&page=view_report&report_id={$report['report_id']}'>(Report)</a>" : "") ?></th></tr>
    <?php if(!empty($posts)): ?>
