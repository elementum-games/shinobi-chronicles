    ...
    $(document).ready(function () {
        ...
        $(".jutsu_block_expand").on('click', function () {
            if ($("#" + $(this).attr("data-target")).attr("data-jutsu_name") == $("#jutsu_name").text()) {
                ...
                $("#jutsu_effect_1").text($("#" + $(this).attr("data-target")).attr("data-jutsu_effect_1"));
                $("#jutsu_effect_2").text($("#" + $(this).attr("data-target")).attr("data-jutsu_effect_2"));
        ...
        $("#jutsu_filter_clash").on('click', function () {
            filter();
        });
        ...
        function filter() {
            ...
            jutsu.each(function() {
                ...
                if ($("#jutsu_filter_buff").is(':checked')) {
                    if (jutsuEffect.includes('Release Genjutsu') || jutsuEffect.includes('Boost')) {
                        hideJutsu = false;
                    }
                }
