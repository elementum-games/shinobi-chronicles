        ...
        <tr>
            <td style="text-align: center;">
                ...
                <?php if(!$player->reputation->benefits[UserReputation::BENEFIT_PARTIAL_TRAINING_GAINS]): ?>
                    You will not gain any of your potential <?= (!empty($system->event) && $system->event->exp_modifier > 1) ? $player->trainingManager->train_gain * $system->event->exp_modifier : $player->trainingManager->train_gain ?> gains.
                <?php else: ?>
                    <?= $partial_gain ?>
                <?php endif ?>
                <br />
