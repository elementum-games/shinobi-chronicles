...
function adminPanel() {
	...
	{	/* Edit User*/
		$edit_user_variables = array(	
			...
			'premium_credits' => array(
				'data_type' => 'int',
				'input_type' => 'text'
			),
			'premium_credits_purchased' => array(
				'data_type' => 'int',
				'input_type' => 'text'
			),
			'pvp_wins' => array(
			...
			'ninjutsu_skill' => array(
				'data_type' => 'float',
				'input_type' => 'text'
			),
			'taijutsu_skill' => array(
				'data_type' => 'float',
				'input_type' => 'text'
			),
			'genjutsu_skill' => array(
				'data_type' => 'float',
				'input_type' => 'text'
			),
			'bloodline_skill' => array(
				'data_type' => 'float',
				'input_type' => 'text'
			),
			'cast_speed' => array(
			...
			'village' => array(
				'data_type' => 'string',
				'input_type' => 'radio',
				'options' => array('Stone', 'Cloud', 'Leaf', 'Sand', 'Mist')
			)
		);
	}
	{	/* AI */
			...
			'moves' => array(
				...
				'variables' => array(
					...
					'jutsu_type' => array(
						'data_type' => 'string',
						'input_type' => 'text',
						'options' => array('ninjutsu', 'taijutsu', 'genjutsu')
					)
				)
			)
		);
	...
	{	/* Jutsu */
		...
		$jutsu_variables = array(
			...
			'element' => array(
				'data_type' => 'string',
				'input_type' => 'text',
				'options' => array('None', 'Fire', 'Earth', 'Wind', 'Water', 'Lightning')
			),
			'cooldown' => array(
				'data_type' => 'int',
				'input_type' => 'text'
			...
			'use_type' => array(
				'data_type' => 'string', 
				'input_type' => 'radio',
				'options' => array('physical', 'projectile', 'buff', 'barrier')
			),
			'jutsu_type' => array(
				'data_type' => 'string', 
				'input_type' => 'radio',
				'options' => array('ninjutsu', 'genjutsu', 'taijutsu')
			),
			'purchase_type' => array(
				'data_type' => 'int',
				'input_type' => 'radio',
				'options' => array(1 => 'default', 2 => 'purchasable', 3 => 'non-purchasable')
			),
			'effect' => array(
				'data_type' => 'string',
				'input_type' => 'radio',
	...
	{	/* Item  */
		...
		$item_variables = array(
			...
			'purchase_type' => array(
				'data_type' => 'int',
				'input_type' => 'radio',
				'options' => array(1 => 'purchasable', 2 => 'event')
			),
			'use_type' => array(
				'data_type' => 'int',
				'input_type' => 'radio',
				'options' => array(1 => 'weapon', 2 => 'armor', 3 => 'consumable')
			),
			'effect' => array(
				'data_type' => 'string',
				'input_type' => 'radio',
	...
	{	/* Bloodline */
		...
		$passive_boosts = array(
			'scout_range',
			'stealth',
			'regen'
		);
		$bloodline_variables = array(
			'name' => array(
				'data_type' => 'string',
				'input_type' => 'text',
				'max_length' => 100
			...
			'rank' => array(
				'data_type' => 'int',
				'input_type' => 'radio',
				'options' => array(5 => 'Admin', 4 => 'Lesser', 3 => 'Common', 2 => 'Elite', 1 => 'Legendary')
			),
			'village' => array(
				'data_type' => 'string',
				'input_type' => 'radio',
	...
	{	/* Clan */
		...
		$edit_clan_variables['points'] = array(
			'data_type' => 'int',
			'input_type' => 'text'
		);
		$edit_clan_variables['leader'] = array(
			'data_type' => 'int',
			'input_type' => 'text'
		);
		$edit_clan_variables['elder_1'] = array(
			'data_type' => 'int',
			'input_type' => 'text'
		);
		$edit_clan_variables['elder_2'] = array(
			'data_type' => 'int',
			'input_type' => 'text'
		);
		$edit_clan_variables['challenge_1'] = array(
			'data_type' => 'string',
			'input_type' => 'text'
		);
		$edit_clan_variables['motto'] = array(
			'data_type' => 'string',
			'input_type' => 'text',
			'max_length' => 175
		);
		$edit_clan_variables['info'] = array(
			'data_type' => 'string',
			'input_type' => 'text',
			'max_length' => 750
		);
	...
	{	/* Team */
		$team_variables = array(
			...
			'type' => array(
				'data_type' => 'int',
				'input_type' => 'radio',
				'options' => array(1 => 'Shinobi', 2 => 'ANBU')
			),
			'boost' => array(
				'data_type' => 'string',
				'input_type' => 'text',
	...
	{	/* Mission */
		$mission_stage_variables = array(
			'action_type' => array(
				'data_type' => 'string',
				'input_type' => 'radio',
				'options' => array('travel', 'search', 'combat')
			),
			'action_data' => array(
				'data_type' => 'string',
				'input_type' => 'text'
		...
		$mission_variables = array(
			...
			'rank' => array(
				'data_type' => 'int',
				'input_type' => 'radio',
				'options' => array(1 => 'D-Rank', 2 => 'C-Rank', 3 => 'B-Rank', 4 => 'A-Rank', 5 => 'S-Rank')
			),
			'mission_type' => array(
				'data_type' => 'int',
				'input_type' => 'radio',
				'options' => array(1 => 'Village', 2 => 'Clan', 3 => 'Team', 4 => 'Special', 5 => 'Survival')
			),
			'money' => array(
				'data_type' => 'int',
				'input_type' => 'text'
